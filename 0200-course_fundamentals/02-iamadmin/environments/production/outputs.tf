...
output "iam_user_password" {
  ...
  value       = module.iam_admin.iam_user_password
  sensitive   = true
}
...
output "iam_user_name" {
  ...
  value       = module.iam_admin.iam_user_name
}

output "iam_user_arn" {
  description = "The ARN of the IAM user"
  value       = module.iam_admin.iam_user_arn
} 